...
% \usepackage{packages/lettrine} % The lettrine is the first enlarged letter at the beginning of the text
% \usepackage{packages/enumitem} % Customized lists
