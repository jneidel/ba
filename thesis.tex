...
Problemstellung dieser Arbeit soll das zweite der gelisteten Probleme sein: Das Zusammentragen und Evaluieren der Faktoren welche Kommandozeilen Applikation für Neulinge zugänglich machen. Oder konkreter als Forschungfrage definiert:
...
\begin{enumerate}
  \item Eine Auflistung von Problemen mit Kommandozeilen Interfaces
...
auf das Problem, als Methoden formuliert dokumentiert werden.
\\
...
zugänglich für Neulinge machen.
\\
