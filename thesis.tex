...
Obiger Auszug aus dem Hilfsmenü von \codeinline{hour list} kommuniziert das die
\codeinline{--date} Flagge wenn nicht übergeben den Wert \codeinline{this week}
annimmt. Wird das Subkommando \codeinline{hour list} ohne Flaggen aufgerufen
...
das \codeinline{add} Subkommando auch das meist verwendete.
