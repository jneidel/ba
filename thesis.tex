...
Aufgabe 16 stellt den letzten der Extremfälle dar und ist der einzige Auftritt
...
nur bei sechs Aufgaben mehr als $100\%$ Performance Differenz festgestellt, also
das ein Interface mehr als doppelt so schnell ist als das andere. Auf diese
...
\href{https://github.com/jneidel/oraclett}{https://github.com/jneidel/oraclett}

\section{Rohdaten}

Nachfolgend die in der Evaluation erhobenen Performancedaten. Diese wurden mit
Octave verarbeitet und dargestellt.
...
\inputminted[
  ...
  framesep=2mm,
  fontsize=\footnotesize
]{matlab}{script.octave}

\newpage

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.55]{data-gui.png}
  \caption{Daten der Attraktivitätsumfrage: GUI}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.55]{data-cli.png}
  \caption{Daten der Attraktivitätsumfrage: CLI}
\end{figure}
